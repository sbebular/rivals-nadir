...
set_attack_value(AT_DTILT, AG_HURTBOX_SPRITE, asset_get("ex_guy_crouch_box"));
...
set_window_value(AT_DTILT, 3, AG_WINDOW_ANIM_FRAME_START, 0);
set_window_value(AT_DTILT, 3, AG_WINDOW_CANCEL_TYPE, 0);
